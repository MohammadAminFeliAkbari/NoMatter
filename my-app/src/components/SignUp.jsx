...
export default function SignUp () {
  ...
  const handleSubmit = e => {
    ...
    if (flag) {
      ...
      setTimeout(() => {
        setButton(false)
        return toast.error('خطای سرور رخ داده')
      }, 3000)
    }
  }
  ...
  const handleError = identifier => {
    return didEdit[identifier] && value[identifier].length === 0
      ? error[0]
      : null
  }
      ...
      >
        ...
        <div className='mb-4'>
          ...
          {didEdit.username && value.username.length === 0 && (
            <span className='text-red-700 text-[12px] mt-1 translate-x-[-10px] font-bold'>
              {error[0]}
            </span>
          )}
        </div>
        ...
        <div className='mb-4'>
          ...
          {didEdit.postalCode &&
            value.postalCode.length !== 10 &&
            value.postalCode.length > 0 && (
              <span className='text-red-700 text-[12px] mt-1 translate-x-[-10px] font-bold'>
                {error[1]}
              </span>
            )}
